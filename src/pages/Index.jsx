            ...
            Calculate Fare
              ...
              <Box mt={8}>
                ...
                <Box mt={4} p={4} bg="gray.100" borderRadius="md">
                  <Text fontSize="xl" mb={2}>Fare Breakdown:</Text>
                  <Text>Start Fare: £{startFare.toFixed(2)}</Text>
                  <Text>Distance Fare: £{distanceFare.toFixed(2)}</Text>
                  <Text>Additional Passengers Fare: £{additionalPassengersFare.toFixed(2)}</Text>
                  <Text>Children Fare: £{childrenFare.toFixed(2)}</Text>
                  <Text>Luggage Fare: £{luggageFare.toFixed(2)}</Text>
                  <Text>Cycles Fare: £{cyclesFare.toFixed(2)}</Text>
                  <Text>Waiting Time Fare: £{waitingTimeFare.toFixed(2)}</Text>
                </Box>
              </Box>
            </Box>
          </GridItem>
